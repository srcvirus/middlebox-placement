...
struct middlebox {
  ...
  std::string GetDebugString() {
    return "middlebox_name : " + middlebox_name +
           ", cpu_requirement : " + std::to_string(cpu_requirement) +
           ", processing_delay : " + std::to_string(processing_delay) +
           ", processing_capacity : " + std::to_string(processing_capacity) +
           ", deployment_cost : " + std::to_string(deployment_cost);
  }
};
...
struct traffic_class {
  ...
  std::string GetDebugString() {
    return "class_name : " + class_name +
           ...
           ", max_delay : " + std::to_string(max_delay) +
           ", delay_penalty : " + std::to_string(delay_penalty);
  }
};
...
struct traffic_request {
  ...
  std::string GetDebugString() {
    return "source : " + std::to_string(source) +
           ...
           ", sla_specification : " + std::to_string(sla_specification) +
