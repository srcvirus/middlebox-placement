...
plot "log.viterbi.i2.egress_k.cdf" using 1:2 title "Heuristic-Internet2" w linespoints ls 2, \
     "log.cplex.i2.egress_k.cdf" using 1:2 title "CPLEX-Internet2" w linespoints ls 3, \
