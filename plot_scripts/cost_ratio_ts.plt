...
set size 1.0, 0.28
plot    	"log.total_cost_ratio" using 1:2 title "Total Cost" w line lc rgb '#FA160E' lt 5
...
plot    	"log.energy_cost_ratio" using 1:2 title "Energy Cost" w line lt 3
...
plot    	"log.transit_cost_ratio" using 1:2 title "Transit Cost" w line lc rgb '#9FBB55' lt 1

set origin 0.0225, 0.655
set size 0.977,0.24
...
plot    	"log.sla_cost_ratio" using 1:2 title "SLA Violation Cost" w line lc rgb '#6F9BDD' lt 7
